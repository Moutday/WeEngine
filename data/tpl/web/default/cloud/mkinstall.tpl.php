...
<div class="alert alert-info">
	...
	3、如果在安装遇到什么问题，请联系在线客服QQ：<a target=blank href=http://wpa.qq.com/msgrd?V=3&uin=77587933&Site=北通信息科技&Menu=yes><img border="0" src="http://auth.beitog.cn/center/view/default/assets/i/qq.png" alt="北通信息科技" title="北通信息科技"></a>
</div>
		...
		<td class="text-left">
			<div class="link-group">
              <?php  if($row['found'] == 0 ) { ?>
				...
				<a href="<?php  echo url('module/manage-system/not_installed', array('support' => 'account_support'))?>">首装</a>
              <?php  } else { ?>
              	<?php  if($row['version'] > module_ver($row['name']) ) { ?>
